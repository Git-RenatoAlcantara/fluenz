...
| Tag do Vídeo | Atributo RPG | Classe Beneficiada |
| Gramática/Aulas | Intelecto | Scholar (Escriba) |
| Podcasts/Conversa | Carisma | Bard (Bardo) |
| Filmes/Séries | Percepção | Ranger (Patrulheiro) |
| Notícias/Tech | Sabedoria | Mage (Mago) |
